...
// ProductCard (same as CategoryPage)
...
// SkeletonCard (same as CategoryPage)
...
// Filters component (same as CategoryPage)
function Filters({ 
...
function SearchPage() {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    return filtered;
  }, [rawProducts, minPrice, maxPrice, minRating, sortBy]);
  ...
  const fetchProducts = async () => {
    try {
      ...
      const url = `${API_BASE_URL}/search?q=${encodeURIComponent(searchTerm)}&limit=100`;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6 animate-fadeIn">
          <h1 className="text-2xl font-bold text-gray-900">Search Results for "{decodedSearchTerm}"</h1>
        </div>
        ...
        {loading && rawProducts.length === 0 ? (
          ...
          <div className="text-center text-gray-600 py-12">
            No products found matching your filters for "{decodedSearchTerm}". Try adjusting your filters.
          </div>
        ) : (
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
